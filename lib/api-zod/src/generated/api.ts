...
export const ListDiariasQueryParams = zod.object({
  ...
  "sortBy": zod.union([zod.literal('providerName'),zod.literal(null)]).nullish().describe('Agrupa por nome do prestador em ordem alfabética e ordena suas datas trabalhadas da mais antiga para a mais recente'),
